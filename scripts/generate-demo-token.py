...
def open_output_folder(path: pathlib.Path) -> None:
    """
    Open the generated output folder in the operating system's file manager.
    Works on Windows, macOS, and most Linux desktop environments.
    """
    try:
...
def main():
    ...
    print("  token.txt  — raw JWT")
    print("  url.txt    — activation URL")
    print("  qr.png     — QR code")

    # --- open output folder ---
    open_output_folder(out_dir.resolve())
