...
test('audiobook detail page displays character metadata from backend', async ({ context, page }) => {
  ...
  const characterProject = {
    id: 'project-with-roles',
    title: 'Story with Character Roles',
    status: 'NEEDS_REVIEW',
    sceneCount: 2,
    speakerCount: 2,
    totalDurationSeconds: 185,
    ...
    scenes: [
      {
        ...
        speakerRoleDescription: 'Story narrator',
        voiceName: 'aria',
        performanceDirections: '[calm] The story begins...'
      },
      {
        id: 'scene-2',
        orderIndex: 1,
        ...
        speakerRoleDescription: 'Protagonist',
        voiceName: 'nova',
        performanceDirections: '[energetic] Hello world!'
      }
    ],
    audioAssets: [
      {
        ...
        downloadUrl: '/api/audiobooks/project-with-roles/audio-assets/asset-full/download',
        streamUrl: '/api/audiobooks/project-with-roles/audio-assets/asset-full/stream'
      },
      {
        id: 'asset-scene-1',
        sceneId: 'scene-1',
        ...
        status: 'READY',
        createdAt: '2026-05-10T10:00:00Z',
        downloadUrl: '/api/audiobooks/project-with-roles/audio-assets/asset-scene-1/download',
        streamUrl: '/api/audiobooks/project-with-roles/audio-assets/asset-scene-1/stream'
      },
      {
        id: 'asset-scene-2',
        sceneId: 'scene-2',
        ...
        status: 'READY',
        createdAt: '2026-05-10T10:00:00Z',
        downloadUrl: '/api/audiobooks/project-with-roles/audio-assets/asset-scene-2/download',
        streamUrl: '/api/audiobooks/project-with-roles/audio-assets/asset-scene-2/stream'
      }
    ]
  };
