...
public enum SpeakerVoice {
    ...
    private final int deepnessScale;

    SpeakerVoice(String voice, String style, String styleDescription, Gender gender, int deepnessScale) {
        this.key = voice;
        this.style = style;
        this.styleDescription = styleDescription;
        this.gender = gender;
        this.deepnessScale = deepnessScale;
    }
    ...
    public int getDeepnessScale() {
        return deepnessScale;
    }
